...
\begin{document}
    ...
    \section{Vibrações livres não Amortecidas - 1 DOF}
        ...
        \section{Vibrações Forçadas de Sistemas de 1 \emph{DOF} sem Amortecimento - Excitação Harmônica}
            ...
            Diferenciais Homogêneas}. Agora, entretanto, iremos estudar sistemas sem amortecimento que sofrem a ação de uma força periódica, chamada de excitação harmônica, que resultará em uma
